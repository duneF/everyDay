 ...
 * Generated at: 2017-12-11 03:38:58 UTC
...
public final class item_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("//                return ;\r\n");
      out.write("//            }\r\n");
      out.write("//            $.messager.confirm('确认','确定导出ID为 '+ids+' 的商品吗？',function(r){\r\n");
      out.write("//                if (r){\r\n");
      out.write("//                    var params = {\"ids\":ids};\r\n");
      out.write("//                    $.post(\"/rest/item/outToExcel\",params, function(data){\r\n");
      out.write("//                        if(data.status == 200){\r\n");
      out.write("//                            $.messager.alert('提示','导出商品成功!',undefined,function(){\r\n");
      out.write("//                                $(\"#itemList\").datagrid(\"reload\");\r\n");
      out.write("//                            });\r\n");
      out.write("//                        }\r\n");
      out.write("//                    });\r\n");
      ...
      out.write("                        var params = {\"ids\":ids};\r\n");
      out.write("                       // $.post(\"/rest/item/outToExcel\",params, function(data){\r\n");
      out.write("                        $.post(\"/rest/item/outToExcel\",function(data){\r\n");
      out.write("                            if(data.status == 200){\r\n");
      out.write("                                $.messager.alert('提示','导出商品成功!',undefined,function(){\r\n");
      out.write("                                    $(\"#itemList\").datagrid(\"reload\");\r\n");
      out.write("                                });\r\n");
